...
import { rangeRandom } from '../../../utils/tool'
...
function initModel() {
  ...
  loader.load('@/assets/particle/1game.json', function(geo, materials) {
    geo.center()
    geo.normalize()
  ...
  loader.load('@/assets/particle/2ac.json', function(geo, materials) {
    geo.center()
    geo.normalize()
  ...
  loader.load('@/assets/particle/3book.json', function(geo, materials) {
    geo.center()
    geo.normalize()
  ...
  loader.load('@/assets/particle/4movice.json', function(geo, materials) {
    geo.center()
    geo.normalize()
  ...
  loader.load('@/assets/particle/5kv.json', function(geo, materials) {
    geo.center()
    geo.normalize()
  ...
  loader.load('@/assets/particle/qr.json', function(geo, materials) {
    geo.center()
    geo.normalize()
...
function initMainParticles() {
  ...
  // 圆点
  const mapDot = textureLoader.load(gradient)

  const POINT_LENGTH = window.innerWidth > 780 ? 700 : 200,
    POINT_SIZE = rangeRandom(10, 2)
...
function initAroundParticles() {
  ...
  // 初始化漫游粒子
  const nums = window.innerWidth > 780 ? 300 : 100
