...
function colors(darkMode: boolean): Colors {
  return {
    ...
    borderBt: darkMode ? '#67F8EE' : '#666666',

    //primary colors
    primary1: darkMode ? '#2172E5' : '#E8006F',
    primary2: darkMode ? '#3680E7' : '#FF8CC3',
    primary3: darkMode ? '#7c6d5e' : '#FF99C9',
    primary4: darkMode ? '#376bad70' : '#F6DDE8',
    primary5: darkMode ? '#7c6d5e' : '#FDEAF1',

    // color text
    primaryText1: darkMode ? '#7c6d5e' : '#D50066',
